...
public class EmployeeSidePreferencesConstants {

    public static final String EMP_ID = "emp_id";
    public static final String EMP_NUMBER = "emp_number";
    public static final String EMP_NAME = "emp_name";
    public static final String EMP_MAIN_SCHOOL_ID = "emp_main_school_id";
...
//    public static final String EMP_STATUS = "emp_status";
    ...
    public static final String EMP_INSTITUTE_ID = "emp_institute_id";
    public static final String EMP_IM_DOMAIN_NAME = "emp_im_domain_name";
